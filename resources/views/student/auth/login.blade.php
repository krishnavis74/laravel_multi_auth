<x-guest-layout>
    ...
    <form method="POST" action="{{ route('student_login') }}">
        @csrf
        <div class="text-center">Student Login</div>
        <!-- Email Address -->
        <div>
            <x-input-label for="email" :value="__('Email')" />
            <x-text-input id="email" class="block mt-1 w-full" type="email" name="student_email" :value="old('email')" required autofocus autocomplete="username" />
