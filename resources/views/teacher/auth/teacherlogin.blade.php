<x-guest-layout>
    ...
    <form method="POST" action="{{ route('teacher_login') }}">
        @csrf
        <div class="text-center">Teacher Login</div>
        <!-- Email Address -->
        <div>
            <x-input-label for="email" :value="__('Email')" />
            <x-text-input id="email" class="block mt-1 w-full" type="email" name="teacheer_email"
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password" class="block mt-1 w-full" type="text" value="12345678" name="password"
