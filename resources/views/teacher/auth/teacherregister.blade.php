<x-guest-layout>
    ...
    <form method="POST" action="{{ route('teacher_register') }}">
        @csrf
        <div class="text-center">Teacher Register</div>
        <!-- Name -->
        <div>
            <x-input-label for="name" :value="__('Teacher Name')" />
            <x-text-input id="name" class="block mt-1 w-full" type="text" name="teacher_name" :value="old('name')"
        ...
        <div class="mt-4">
            ...
            <x-text-input id="email" class="block mt-1 w-full" type="email" name="teacher_email" :value="old('email')"
